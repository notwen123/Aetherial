...
export interface AetherialTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface AetherialToken extends BaseContract {
  connect(runner?: ContractRunner | null): AetherialToken;
  waitForDeployment(): Promise<this>;

  interface: AetherialTokenInterface;
