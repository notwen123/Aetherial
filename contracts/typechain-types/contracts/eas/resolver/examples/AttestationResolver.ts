...
export interface AttestationResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attest"
      | "isPayable"
...
export interface AttestationResolver extends BaseContract {
  connect(runner?: ContractRunner | null): AttestationResolver;
  waitForDeployment(): Promise<this>;

  interface: AttestationResolverInterface;
  ...
  toBytes32: TypedContractMethod<
    [data: BytesLike, start: BigNumberish],
    [string],
    "view"
  >;
