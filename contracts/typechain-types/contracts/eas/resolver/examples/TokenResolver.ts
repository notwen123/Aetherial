...
export interface TokenResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attest"
      | "isPayable"
...
export interface TokenResolver extends BaseContract {
  connect(runner?: ContractRunner | null): TokenResolver;
