...
export interface RevocationResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attest"
      | "isPayable"
  ...
  encodeFunctionData(
    functionFragment: "setRevocation",
    values: [boolean]
  ): string;
...
export interface RevocationResolver extends BaseContract {
  connect(runner?: ContractRunner | null): RevocationResolver;
  waitForDeployment(): Promise<this>;

  interface: RevocationResolverInterface;
  ...
  setRevocation: TypedContractMethod<[status: boolean], [void], "nonpayable">;
