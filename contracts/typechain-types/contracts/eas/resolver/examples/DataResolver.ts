...
export interface DataResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attest"
      | "isPayable"
...
export interface DataResolver extends BaseContract {
  connect(runner?: ContractRunner | null): DataResolver;
