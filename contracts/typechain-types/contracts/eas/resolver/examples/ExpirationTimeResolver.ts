...
export interface ExpirationTimeResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attest"
      | "isPayable"
...
export interface ExpirationTimeResolver extends BaseContract {
  connect(runner?: ContractRunner | null): ExpirationTimeResolver;
  waitForDeployment(): Promise<this>;

  interface: ExpirationTimeResolverInterface;
