...
export interface ValueResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attest"
      | "isPayable"
...
export interface ValueResolver extends BaseContract {
  connect(runner?: ContractRunner | null): ValueResolver;
