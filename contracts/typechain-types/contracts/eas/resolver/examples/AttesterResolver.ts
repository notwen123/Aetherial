...
export interface AttesterResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attest"
      | "isPayable"
...
export interface AttesterResolver extends BaseContract {
  connect(runner?: ContractRunner | null): AttesterResolver;
  waitForDeployment(): Promise<this>;

  interface: AttesterResolverInterface;
