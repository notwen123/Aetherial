...
export interface RecipientResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attest"
      | "isPayable"
...
export interface RecipientResolver extends BaseContract {
  connect(runner?: ContractRunner | null): RecipientResolver;
