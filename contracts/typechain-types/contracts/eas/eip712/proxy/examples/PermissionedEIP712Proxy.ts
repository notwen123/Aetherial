...
export interface PermissionedEIP712ProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "attestByDelegation"
...
export interface PermissionedEIP712Proxy extends BaseContract {
  connect(runner?: ContractRunner | null): PermissionedEIP712Proxy;
  waitForDeployment(): Promise<this>;

  interface: PermissionedEIP712ProxyInterface;
