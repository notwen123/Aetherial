...
export interface TestEASInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attest"
      | "attestByDelegation"
...
export interface TestEAS extends BaseContract {
  connect(runner?: ContractRunner | null): TestEAS;
  ...
  setTime: TypedContractMethod<[newTime: BigNumberish], [void], "nonpayable">;
