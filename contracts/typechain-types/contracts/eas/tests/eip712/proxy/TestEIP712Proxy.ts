...
export interface TestEIP712ProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attestByDelegation"
      | "eip712Domain"
  ...
  encodeFunctionData(
    functionFragment: "verifyAttest",
    values: [DelegatedProxyAttestationRequestStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "verifyRevoke",
    values: [DelegatedProxyRevocationRequestStruct]
  ): string;
...
export interface TestEIP712Proxy extends BaseContract {
  connect(runner?: ContractRunner | null): TestEIP712Proxy;
  waitForDeployment(): Promise<this>;

  interface: TestEIP712ProxyInterface;
  ...
  verifyAttest: TypedContractMethod<
    [request: DelegatedProxyAttestationRequestStruct],
    [void],
    "nonpayable"
  >;

  verifyRevoke: TypedContractMethod<
    [request: DelegatedProxyRevocationRequestStruct],
    [void],
    "nonpayable"
  >;
