...
export interface TestSchemaResolverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "attest"
      | "isPayable"
...
export interface TestSchemaResolver extends BaseContract {
  connect(runner?: ContractRunner | null): TestSchemaResolver;
  waitForDeployment(): Promise<this>;

  interface: TestSchemaResolverInterface;
